...
import { Upload, Trash2, Home, CheckCircle, Lock, LogOut, Edit2, X, Save, Palette, Loader2, Settings } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 relative">
        ...
        {activeTab === 'photos' && (
          <div className="animate-fade-in">
            ...
            {/* Upload Area */}
            <div
              className={`mb-12 border-2 border-dashed rounded-xl p-12 text-center transition-all duration-300 ${isDragging
              ...
              <div className="grid grid-cols-2 sm:grid-cols-5 gap-4">
                {(['amber', 'sky', 'rose', 'emerald', 'violet'] as ThemeColor[]).map((color) => (
                  <button
                    ...
                    className={`group relative p-4 rounded-lg border-2 transition-all flex flex-col items-center gap-2 ${config.themeColor === color
